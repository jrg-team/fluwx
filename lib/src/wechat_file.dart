...
class WeChatFile {
  ...
  WeChatFile.network(String source, {String suffix})
      : assert(source.startsWith("http")),
        ...
        this.suffix = readSuffix(source, suffix, defaultSuffixTxt);
  ...
  WeChatFile.file(File source, {String suffix = defaultSuffixTxt})
      : this.source = source.path,
        ...
        this.suffix = readSuffix(source.path, suffix, defaultSuffixTxt);
...
String readSuffix(String string, String suffix, String defaultSuffix) {
  ...
  var path = Uri.parse(string).path;
